...
public final class ModDependencyIdentifierImpl implements ModDependencyIdentifier {
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ModDependencyIdentifierImpl)) return false;
		ModDependencyIdentifierImpl that = (ModDependencyIdentifierImpl) o;
		return Objects.equals(mavenGroup, that.mavenGroup) && Objects.equals(id, that.id);
	}

	@Override
	public int hashCode() {
		return Objects.hash(mavenGroup, id);
	}
}
